...
<div class="panel-body">
	<table class="table table-bordered table-striped">
		...
		<tr>
			<td>Laporan Data Dosen</td>
			<td>
			<a href="laporan_dosen.php" target="_blank"><button class="btn btn-primary btn-sm"  > CETAK</button></a>
				</td>
		</tr> 
		<tr>
			<td>
			...
			<td>
			<a href="laporan_mahasiswa.php" target="_blank"><button class="btn btn-primary btn-sm" > CETAK</button></a>
			</td>
		</tr>
